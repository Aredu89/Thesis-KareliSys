...
export default class IngresosFecha extends React.Component {
	constructor(){
		super()
		this.state = {
			desde: "",
			...
			<div className="fabricas-pagos">
				<div className="row">
					...
					<div className="mensaje-deuda">
						<h4>El total de ingresos es de: {Funciones.moneyFormatter(this.state.ingresos)}</h4>
					</div>
					{/* Detalle */}
              ...
              :
                this.state.errorEgresos ?
                  ...
                  <div className="alert alert-dismissible alert-danger">
                    ...
                    <strong>Error!</strong> {this.state.errorIngresos}
                  </div>
                :
                  // Spinner
